...
external_asset_keys = {
    "dlt_customers_source_customers": dg.AssetDep(dg.AssetKey("sftp_customers")),
    "dlt_orders_source_orders": dg.AssetDep(dg.AssetKey("sftp_orders")),
    "dlt_products_source_products": dg.AssetDep(dg.AssetKey("sftp_products"))
}
