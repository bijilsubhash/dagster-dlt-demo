...
external_asset_keys = {
    "customers": dg.external_asset(key=dg.AssetKey("sftp_customers")),
    "orders": dg.external_asset(key=dg.AssetKey("sftp_orders")),
    "products": dg.external_asset(key=dg.AssetKey("sftp_products"))
}
